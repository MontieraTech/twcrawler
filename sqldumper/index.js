...
// import  debug from 'debug''dmpr');
// var error = require('debug')('reports-server:reportsmngr:error');
...
var rptObj = function (rid) {
	...
	this.addToRecords = function (currentValues) {
		...
		this.records.push(util.format("(%s)", _.values(formatterValues).join(",")));
